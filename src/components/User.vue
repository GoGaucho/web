...
<template>
  ...
  <div class="fixed z-50 top-16 w-72 rounded shadow-lg bg-white all-transition" :class="showPanel ? 'right-2' : '-right-72'">
    <wrapper :show="showPanel" class="pt-4 flex flex-col items-center">
      ...
      <button class="all-transition w-full text-gray-500 flex items-center px-6 py-3 border border-x-0 border-t-0 hover:bg-gray-50" @click="goto('/registration')">
        <information-circle-icon class="w-6 mr-2" />Registration Info.
      </button>
