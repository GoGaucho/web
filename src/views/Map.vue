...
async function init () {
  ...
  selfBlur = new google.maps.Marker({ position: ll('0, 0'), map, icon: {
    path: 'm -8,0 a 8,8 0 1,0 16,0 a 8,8 0 1,0 -16,0',
    fillColor: '#4285F4', fillOpacity: 0.3, strokeOpacity: 0, scale: 2
  } })
  self = new google.maps.Marker({ position: ll('0, 0'), map, icon: {
    path: 'm -8,0 a 8,8 0 1,0 16,0 a 8,8 0 1,0 -16,0',
